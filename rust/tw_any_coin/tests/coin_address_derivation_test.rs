...
fn test_coin_address_derivation() {
    ...
    for coin in CoinType::iter() {
        ...
        let expected_address = match coin {
            ...
            CoinType::Odin => "odin1ten42eesehw0ktddcp0fws7d3ycsqez3my4uvv",
            CoinType::Doki => "odin1ten42eesehw0ktddcp0fws7d3ycsqez3my4uvv",
            CoinType::MYRK => "odin1ten42eesehw0ktddcp0fws7d3ycsqez3my4uvv",
            CoinType::O9W => "odin1ten42eesehw0ktddcp0fws7d3ycsqez3my4uvv",
